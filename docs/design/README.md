...
| 文档 | 状态 | 关联 Issue | 说明 |
|------|------|------------|------|
| [Issue #17 图床远程对象管理](issue-17-remote-image-management.md) | 已确认（G0 已完成） | [#17](https://github.com/ytahml/obsidian-image-manager/issues/17) | S3-first，优先 Cloudflare R2 与 MinIO |
