export const zh: Record<string, string> = {
    ...
    'modal.imageBrowser.remoteCurrentPageOnly': '搜索和排序仅作用于当前已加载页。',
    ...
    'modal.hosting.remotePageSize': '每页对象数量',
    'modal.hosting.remotePageSizeDesc': '每次手动分页请求的对象数量（1–1000）；服务商可能使用更低上限。',
