export const en: Record<string, string> = {
    ...
    'settings.localManagementModeDesc': 'Only controls who creates new attachments; manual reorganization and upload commands remain available',
    ...
    'settings.reorganizeConvertFormatDesc': 'Convert reorganized references to Markdown',
    'settings.compressManagedPasteLocal': 'Compress managed local attachments',
    'settings.compressManagedPasteLocalDesc': 'Compress only attachments created by Image Manager during paste or drop',
    'settings.compressBeforeUpload': 'Compress before upload',
    'settings.compressBeforeUploadDesc': 'Compress the upload payload without changing the local file',
    ...
    'notice.uploadSuccessWithUrl': 'Upload successful! Reference copied to clipboard.\n{url}',
    ...
    'modal.hosting.remoteS3Only': 'Remote object management supports Aliyun OSS, S3-compatible storage, and Qiniu Kodo',
    ...
    'settings.autoUploadOnPasteDesc.managed': 'Upload after Image Manager creates the local attachment; this preference applies only to managed mode',
    'settings.autoUploadOnPasteDesc.delegated': 'Wait for Obsidian or another plugin to create the attachment, then hand it off for upload; this preference applies only to delegated mode',
    'settings.keepLocalCopy': 'Keep local copy',
    'settings.keepLocalCopyDesc': 'Used only for paste auto-upload; when off, the attachment is trashed after confirming no local references remain and its empty folder is cleaned up',
    ...
    'notice.delegatedUploadFailed': 'Automatic upload failed. Use an explicit upload command to retry.',
