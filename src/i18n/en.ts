export const en: Record<string, string> = {
    ...
    'modal.imageBrowser.remoteCurrentPageOnly': 'Search and sorting apply only to the current loaded page.',
    ...
    'modal.hosting.remotePageSize': 'Objects per page',
    'modal.hosting.remotePageSizeDesc': 'Requested object count per manual page (1–1000). Providers can apply a lower limit.',
